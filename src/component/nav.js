...
const Nav = () => {
  return (
    <div className='nav flex justify-between items-center w-screen' style={{ height: '56px' }}>
      <div className='p-12'>
      ...
      <div className='flex flex-row justify-center items-center mr-5 font-tesla-book text-black'>
        <p className='px-4 button h-8 flex items-center '>Vehicles</p>
        <p className='px-4 button h-8 flex items-center'>Energy</p>
        <p className='px-4 button h-8 flex items-center'>Charging</p>
        <p className='px-4 button h-8 flex items-center'>Discover</p>
        <p className='px-4 button h-8 flex items-center'>Shop</p>
      </div>
      <div className='flex flex-row justify-end items-end p-7'>
        <div className='flex justify-start w-9'>
        <div className='h-8 w-8 button flex justify-center items-center'>
          <svg width="24px" height="24px" viewBox="0 0 24 24">
            <path d="M12 20.5a8.5 8.5 0 1 1 0-17 8.5 8.5 0 0 1 0 17Zm0 1.5c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-6a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm.053-3.533a7.8 7.8 0 0 1 .92-.767 6.97 6.97 0 0 0 .746-.61 2.31 2.31 0 0 0 .468-.635c.126-.253.188-.548.188-.883 0-.374-.082-.723-.246-1.048-.158-.324-.415-.588-.771-.792-.356-.203-.81-.305-1.362-.305-.575 0-1.045.116-1.411.347a1.991 1.991 0 0 0-.788.89c-.06.134-.11.272-.148.413-.111.414-.445.767-.874.767-.428 0-.784-.35-.71-.772.07-.407.2-.79.386-1.15.301-.583.758-1.048 1.37-1.394C10.435 6.176 11.185 6 12.07 6c.93 0 1.687.181 2.273.544.59.358 1.014.803 1.271 1.337.257.533.386 1.07.386 1.608 0 .545-.085 1.012-.254 1.403-.17.385-.375.698-.616.94-.235.242-.55.514-.943.817-.312.247-.561.46-.747.635-.18.176-.33.385-.451.627-.05.099-.087.2-.113.302-.108.424-.422.787-.86.787-.437 0-.806-.356-.76-.79a2.948 2.948 0 0 1 .797-1.743Z" fill="currentColor" />
          </svg>
          </div>
        </div>
        <div className='flex justify-start w-9 '>
